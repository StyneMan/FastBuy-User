...
//                             Center(
//                               child: Text(
//                                 "Gift Card expire ${controller.selectedGiftCard.value.expiryDay} days after purchase".tr,
...
//                         padding: const EdgeInsets.only(bottom: 20),
//                         child: RoundedButtonFill(
//                           title: "Pay ${Constant.amountShow(amount: controller.amountController.value.text)}".tr,
//                           height: 5.5,
//                           color: AppThemeData.primary300,
//                           textColor: AppThemeData.grey50,
//                           fontSizes: 16,
//                           onPress: () async {
//                             Get.to(const SelectGiftPaymentScreen());
//                           },
//                         ),
//                       ),
//                     ),
