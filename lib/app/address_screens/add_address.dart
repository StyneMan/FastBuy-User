...
class _AddAddressState extends State<AddAddress> {
                      ...
                      TextFieldWidget(
                        ...
                        validator: (value) {
                          if (value.toString().isEmpty) {
                            return "House/Floor/Flat number is required".tr;
                          }
                          return null;
                        },
                      ),
                      TextFieldWidget(
                        title: 'Street/Road/Area'.tr,
                        controller:
                            widget.controller.localityEditingController.value,
                        hintText: 'Street/Road/Area'.tr,
                        validator: (value) {
                          if (value.toString().isEmpty) {
  ...
  saveAddress({required AddressListController controller}) async {
    try {
      ...
      var resp = await APIService()
          .saveShippingAddress(accessToken: token, body: body);
