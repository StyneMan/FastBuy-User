...
class _ProductDetailState extends State<ProductDetail> {
  ...
  final Map<Map<String, dynamic>, bool> _selectedVariations = {};
  ...
  void initState() {
    ...
    for (var k in widget.product['variations']) {
      _selectedVariations[k] = false;
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  (widget.product['specifications'] ?? [])?.length < 1
                      ? const SizedBox()
                      : Obx(
                          () => ExpansionPanelList(
                            elevation: 0,
                  ...
                  (widget.product['variations'] ?? [])?.length < 1
                      ? const SizedBox()
                      : Obx(
                          () => ExpansionPanelList(
                            elevation: 0,
                                          ...
                                          return CheckboxListTile(
                                            title: Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "₦${Constant.formatNumber(item['price'])}",
                                                  style: TextStyle(
                                                    color: themeChange.getThem()
                                                        ? AppThemeData.grey50
                                                        : AppThemeData.grey900,
                                            ...
                                            value: _selectedVariations[item],
                                            onChanged: (bool? value) {
                                              setState(() {
                                                _selectedVariations[item] =
                                                    value ?? false;
      ...
      bottomNavigationBar: Padding(
        padding: const EdgeInsets.all(8.0),
        child: cartController.profileController.userData.value.isEmpty
            ? const SizedBox()
            : Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                crossAxisAlignment: CrossAxisAlignment.center,
